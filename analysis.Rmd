...
seeds <- seq(from=100,to=1000*100,by=100)
...
boxplot(m1sim,main="Random foreground (1000 repetitions)",ylab="no. gene sets meeting \"significance\" threshold <0.01",frame=FALSE)
...
boxplot(m2sim,main="Random foreground and gene sets (1000 repetitions)",ylab="no. gene sets meeting \"significance\" threshold <0.01",frame=FALSE)
