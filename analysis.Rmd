...
In this first analysis, we run parallel fora tests, one uses the correct
...
select genes randomly from the genes above the detection threshold (bg list) and compare to
...
When using the correct background, a mean of 0.16 was obtained.
...
plot(abs(mres2$s.dist),-log10(mres2$pANOVA),pch=19,cex=0.6,frame.plot=FALSE,
  ...
  xlim=c(0,0.9),ylim=c(0,50), bty="n")
