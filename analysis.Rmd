...
```{r,mistake5_linechart,fig.height=6,fig.width=6}
...
legend("topleft", legend=c("Up", "Down"),
       col=c("red", "blue"), lty=1, cex=1,pch=19)
grid()

unlink("img/5m.png")
png("img/5m.png", width = 480, height = 480)
plot(1:nrow(df),df$up,type="b",col="red", pch=19, las=1,
  ylab="no. gene sets with FDR<0.05",xlab="gene list length",
  bty="n",xaxt = "n")
axis(1, at = 1:nrow(df), labels=sizes, cex.axis=1,las=2)
...
unlink("img/5m.pdf")
pdf("img/5m.pdf", width = 5, height = 5)
plot(1:nrow(df),df$up,type="b",col="red", pch=19, las=1,
  ylab="no. gene sets with FDR<0.05",xlab="gene list length",
  bty="n",xaxt = "n")
axis(1, at = 1:nrow(df), labels=sizes, cex.axis=1,las=2)
