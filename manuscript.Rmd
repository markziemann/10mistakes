...
AB
Methods lacking detailed information often lead to problems in reproducibility and validation.
Authors should provide the list of tools used, version numbers of tools used, which options were
applied for the analysis, which gene list was used, whether background gene list was applied, which
statistical tests were done, what tools were used to obtain a certain result.
The more descriptive the methodology is, the better for an independent researcher to go through the
analysis or use the results for future experiments.
