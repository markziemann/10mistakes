...
pathways and the combined approach found only 149, that’s 58% less (see Fig 4).
...
```{r,6m,fig.cap="Figure 4. Combining up and downregulated genes into one ORA test yields far fewer results.",echo=FALSE,fig.height=3,fig.width=5}
...
```{r,9m,fig.cap="Figure 5. Reactome gene set growth over time. Gene sets were downloaded from the MSigDB website, except The last bar which represents the latest gene sets downloaded directly from Reactome, not yet incorporated into MSigDB.",echo=FALSE,fig.height=3,fig.width=5}
...
* Karp, P.D., Midford, P.E., Caspi, R. et al. Pathway size matters: the influence of pathway
granularity on over-representation (enrichment analysis) statistics.
BMC Genomics 22, 191 (2021). https://doi.org/10.1186/s12864-021-07502-8
